...
//   return (
//     <div>
//       <motion.div className="pt-7 sticky! top-[204px] h-fit!  border-t border-white/25 bg-[#06070B] gap-[100px] flex justify-between pb-[37px] max-[1200px]:max-w-[450px] max-[1320px]:w-[550px] max-[1450px]:w-[650px] max-[1550px]:w-[750px] w-[861px]">
//         <h3 className="text-[23px] leading-[106%] flex gap-5 items-start font-medium">
//           <div className="block min-w-[9px] min-h-[9px] rounded-full bg-primary mt-[3px]"></div>
//           {title}
//         </h3>
