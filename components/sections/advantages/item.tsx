...
export default function Item({ title, img, desc }: TAdvantage) {
  return (
    <div className=" pt-7 border-t border-white/25 bg-[#06070B] gap-[100px] flex justify-between pb-[37px]">
      ...
      <div className="pt-0.5 w-min flex flex-col gap-[18px]">
        <Image
          ...
          width={500}
          height={250}
          className="object-cover h-[224px] max-w-[446px] rounded-[15px]"
          alt="advanatges"
        />
